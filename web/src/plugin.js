  ...
  return `
    <div class="plug-analysis">
      ...
      <p class="plug-caveat">
        ...
        нет контрольного образца собственных слов, который есть у наших кандидатов, —
        поэтому и точность здесь принципиально ниже. Ни здесь, ни там продукт не
        утверждает, что доказал авторство.
